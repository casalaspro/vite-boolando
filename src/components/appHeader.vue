...
<template>
  <header class="header bg-company white">
    <nav class="container">
      <div class="row">

        <ul class="categories border-black white">
          <li><a href="#">Donna</a></li>
          <li><a href="#">Uomo</a></li>
          <li><a href="#">Bambini</a></li>
        </ul>

        <div class="header--logo border-white white">
          <svg id="Livello_1" data-name="Livello 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1622.05 357.61" fill="white">
            <defs>
              <!-- <style>
                .cls-1 {
                  stroke-width: 0px;
        ...
        <div class="header--cart border-black">
          <a href=""><i class="fa-solid fa-lg fa-user"></i></a>
          <a href=""><i class="fa-regular fa-lg fa-heart"></i></a>
          <a href=""><i class="fa-solid fa-lg fa-bag-shopping"></i></a>
        </div>
 </div>
